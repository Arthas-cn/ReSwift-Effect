...
///
/// All operations are guaranteed to happen on the main thread via @MainActor.
@MainActor
class SubscriptionBox<State>: Hashable {
    ...
    nonisolated static func == (left: SubscriptionBox<State>, right: SubscriptionBox<State>) -> Bool {
